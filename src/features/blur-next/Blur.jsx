...
import { SUBJECTS, EFFECT_PRESETS, SHADER_DEBUG_MODE, resolveSubjects } from './config/subjects.js';
...
export default function Blur() {
  ...
  // Edit subject presets/transforms in: src/blur/config/subjects.js
  const subjects = useMemo(() => resolveSubjects(SUBJECTS, EFFECT_PRESETS), []);
