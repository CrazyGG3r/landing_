...
// ---------------------------------------------------------------------------
// Your animation — paste the full frames array here (or import from a file).
// The quoted-string format  "'  content  '"  is handled automatically.
// ---------------------------------------------------------------------------
  ...
  return (
    <div
      ...
      <FaultyTerminal
        ...
        // ── pixel art ───────────────────────────────────────────────────────
        // Each frame is a 100-wide × 39-tall char grid (your data).
        // Cover the full canvas so the art fills the background naturally.
        pixelFrames={active ? ANIMATION_FRAMES : null}
        pixelFps={12}
        pixelFrameOpacity={0.92}
        pixelFrameCenter={[0.5, 0.5]}
        // Scale: x = fraction of canvas width, y = fraction of canvas height.
        // Your art is 100 cols wide × 39 rows tall.
        // Set these so the art covers most of the screen without being clipped.
          ...
          {[
            ...
            <a
              ...
              onMouseEnter={e => {
                ...
                const next = imageForLabel[label];
